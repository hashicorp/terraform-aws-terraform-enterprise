...
module "private_tcp_active_active" {
  ...
  kms_key_alias                = "${local.friendly_name_prefix}-test-private-tcp-active-active-crash"
  ...
  tfe_subdomain                = "${local.friendly_name_prefix}-test-private-tcp-active-active-crash"
