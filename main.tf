...
module "runtime_container_engine_config" {
  ...
  # Use empty string password when IAM authentication is enabled, otherwise use admin password
  database_password         = local.database_passwordless_aws_use_iam ? "" : local.database.password
