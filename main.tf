...
module "runtime_container_engine_config" {
  ...
  enable_sentinel_mtls                        = var.enable_sentinel_mtls
  redis_ca_cert_path                          = var.enable_redis_mtls ? "/etc/ssl/private/terraform-enterprise/redis/cacert.pem" : null
  redis_client_cert_path                      = var.enable_redis_mtls ? "/etc/ssl/private/terraform-enterprise/redis/cert.pem" : null
  redis_client_key_path                       = var.enable_redis_mtls ? "/etc/ssl/private/terraform-enterprise/redis/key.pem" : null
