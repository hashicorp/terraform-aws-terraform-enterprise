...
output "tfe_license_secret_id" {
  value = var.tfe_license == null ? ( var.tfe_license_data == null ? null : aws_secretsmanager_secret_version.tfe_license_data[0].secret_id ) : aws_secretsmanager_secret_version.tfe_license[0].secret_id
}
