...
output "ptfe_endpoint" {
  value       = module.standalone_rhel_aurora.tfe_url
...
output "replicated_console_url" {
  value       = "${module.standalone_rhel_aurora.tfe_url}:8800"
...
output "ptfe_health_check" {
  value       = "${module.standalone_rhel_aurora.tfe_url}/_health_check"
  description = "The URL with path to access the TFE instance health check."
}

output "health_check_url" {
  value       = module.standalone_rhel_aurora.health_check_url
  description = "The URL with path to access the TFE instance health check."
}

output "replicated_console_password" {
  value       = module.standalone_rhel_aurora.replicated_dashboard_password
